...
;(async () => {
  ...
  await page.screenshot({ path: `${OUT}/r4-days-detail.png`, fullPage: true })

  await page.click('button:has-text("Ver en vista por horas")')
  await page.waitForSelector('button:has-text("Nuevo Huésped")')
  await page.screenshot({ path: `${OUT}/r4-hours-jump.png`, fullPage: true })
